...
6. Test: run `$vibe-security-scan` against a `<lang>` repo with the vulnerability — confirm the rule fires with the right reasoning

## Contributing — add a NEW language

To support Ruby / Java / Kotlin / etc.:
